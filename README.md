# Funktionsweise
Dieses kleine Skript ermöglicht es, eine veröffentlichte Prio-Liste von der Seite https://sahne-team.de per Klick direkt im CSV-Format auszugeben, welches z.B. für den Import in das Addon "Prio 3" benötigt wird. So muss keine Datei mehr lokal gespeichert und geöffnet werden.

# Einrichtung
## 1. Folgenden Code in die Zwischenablage kopieren:
...
## 2. Neues Lesezeichen im Browser erstellen
- Name/Titel: Beliebig (z.B. "Sahne Prio Export")
- URL: Hier den Code aus der Zwischenablage einfügen.
## 3. Wenn die Sahne-Liste öffentlich ist, kann nun per Klick auf das Bookmarklet direkt CSV exportiert werden, ohne die Datei zuerst runter zu laden.
